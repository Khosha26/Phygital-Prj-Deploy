...
const PLANS = [
  ...
  './assets/zones-svg.svg',
  './assets/masterplan/views/master.webp',
  './assets/masterplan/views/zoning.webp', './assets/masterplan/views/planting.webp',
  './assets/masterplan/views/trees.webp'
];

// Per-unit floor-plan pages shown in the tower flow (booklet pages 3–26; 1/2/28 are cover/divider pages, not used).
// Precached so every residence plan is available offline on the kiosk, even with no signal.
const BOOKLET = [
  './assets/floorplans/booklet/p03.webp', './assets/floorplans/booklet/p04.webp',
  './assets/floorplans/booklet/p05.webp', './assets/floorplans/booklet/p06.webp',
  './assets/floorplans/booklet/p07.webp', './assets/floorplans/booklet/p08.webp',
  './assets/floorplans/booklet/p09.webp', './assets/floorplans/booklet/p10.webp',
  './assets/floorplans/booklet/p11.webp', './assets/floorplans/booklet/p12.webp',
  './assets/floorplans/booklet/p13.webp', './assets/floorplans/booklet/p14.webp',
  './assets/floorplans/booklet/p15.webp', './assets/floorplans/booklet/p16.webp',
  './assets/floorplans/booklet/p17.webp', './assets/floorplans/booklet/p18.webp',
  './assets/floorplans/booklet/p19.webp', './assets/floorplans/booklet/p20.webp',
  './assets/floorplans/booklet/p21.webp', './assets/floorplans/booklet/p22.webp',
  './assets/floorplans/booklet/p23.webp', './assets/floorplans/booklet/p24.webp',
  './assets/floorplans/booklet/p25.webp', './assets/floorplans/booklet/p26.webp'
];

const ASSETS = [
  // home / intro
  './assets/home-bg.webp', './assets/plate-2560.webp', './assets/bg-inner.webp', './assets/embassy-one-logo.svg',
  // correct client logo lockup (bone + ink)
  './assets/brand/one-pr-bone.webp', './assets/brand/one-pr-ink.webp', './assets/brand/one-coin-nb.webp',
  ...
  // home buttons + lantern (legacy plaque art — still precached; harmless if unused)
  ...
  // renders
  './assets/renders/exterior/tower-inside.webp', './assets/renders/exterior/tower-scene.webp', './assets/renders/exterior/tower-hero.webp',
  './assets/renders/exterior/tower-outline.webp', './assets/renders/exterior/tower-outline-bone.webp',
...
self.addEventListener('install', (e) => {
  e.waitUntil(
    caches.open(CACHE).then(async (c) => {
      ...
      await Promise.allSettled([...ASSETS, ...PLANS, ...BOOKLET].map((u) => c.add(u)));  // tolerant: one 404 won't abort
