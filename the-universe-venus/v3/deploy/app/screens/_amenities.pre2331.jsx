  ...
  return (
    ...
    >
      ...
      <div className="mono" style={{
        flex:1, fontSize: Math.round(16 + dens*4), letterSpacing:'0.26em', textTransform:'uppercase',
        color: active ? 'var(--ink)' : 'var(--graphite)', fontWeight: active ? 700 : 500,
      }}>{g.label}</div>
      <div className="mono" style={{
        fontSize: Math.round(14 + dens*3), letterSpacing:'0.14em', fontVariantNumeric:'tabular-nums',
      ...
      {AM_LEVELS.map(lv => {
        ...
        return (
          <button key={lv} onClick={()=>setLevel(lv)} style={{
            ...
            fontFamily:'ui-monospace, monospace', fontSize: Math.round(13 + dens*3), letterSpacing:'0.16em',
  ...
  return (
    ...
    >
      ...
      <div style={{position:'absolute', top:12, right:12, padding:`${Math.round(4+dens*2)}px ${Math.round(11+dens*2)}px`, borderRadius:105,
        ...
        <span className="mono" style={{fontSize: 10.5 + dens*2, letterSpacing:'0.22em', color:'var(--gold-soft)', textTransform:'uppercase'}}>{item.level}</span>
      </div>
      {/* active "+" chip */}
      {active && (
      ...
      <div style={{position:'absolute', left:18, right:18, bottom: Math.round(14+dens*4), textAlign:'left'}}>
        <span className="serif" style={{fontSize: Math.round(22 + dens*6), fontWeight:300, letterSpacing:'-0.01em',
    ...
    <div style={{position:'absolute', inset:0, background:'transparent', color:'var(--ink)', overflow:'hidden'}}>
      ...
      <div style={{position:'absolute', top:300, left:72, right:72, bottom:56, display:'flex', gap:34}}>
        ...
        <div style={{
          ...
          <div className="mono" style={{fontSize: Math.round(15 + dens*3), letterSpacing:'0.42em', color:'var(--gold-deep)'}}>
          ...
          <div className="mono" style={{fontSize: Math.round(13.5 + dens*3), letterSpacing:'0.28em', color:'var(--slate)', textTransform:'uppercase', marginTop: Math.round(18 + dens*6)}}>
          ...
          <div style={{marginTop: Math.round(26 + dens*10)}}>
            <div className="mono" style={{fontSize: Math.round(13 + dens*3), letterSpacing:'0.32em', color:'var(--slate)', textTransform:'uppercase', marginBottom: Math.round(14 + dens*4)}}>
              Filter by level
            </div>
        ...
        <div style={{flex:1, minWidth:0, position:'relative', opacity:eHero, transform:`scale(${lerp(0.985,1,eHero)})`, transformOrigin:'center'}}>
          <div style={{
            ...
            <div style={{position:'absolute', top:24, right:24, display:'flex', alignItems:'center', gap:8,
              ...
              <div className="mono" style={{fontSize:12, letterSpacing:'0.08em', color:'var(--ink)',
            ...
            <div style={{position:'absolute', left:48, right:48, bottom:104, pointerEvents:'none'}}>
              ...
              <div style={{display:'flex', alignItems:'center', gap:16, marginTop:16}}>
                ...
                <div style={{fontSize:18, color:'rgba(250,246,232,0.82)', fontStyle:'italic', lineHeight:1.4, maxWidth:560}}>
                  {AM_DESC[cat.id] || ''}
                </div>
              </div>
            </div>
        ...
        <div style={{
          ...
          <div style={{display:'flex', alignItems:'baseline', justifyContent:'space-between', paddingBottom: Math.round(14+dens*4),
            ...
            <div className="mono" style={{fontSize: Math.round(13 + dens*3), letterSpacing:'0.36em', color:'var(--gold-deep)', textTransform:'uppercase'}}>
              In this wing
            </div>
            <div className="mono" style={{fontSize: Math.round(13 + dens*3), letterSpacing:'0.2em', color:'var(--slate)', fontVariantNumeric:'tabular-nums'}}>
              {level === 'All'
                ? `${items.length} TOTAL`
