    ...
    <div style={{position:'absolute', inset:0, background:'transparent', color:'var(--ink)', overflow:'hidden'}}>
      ...
      <div style={{position:'absolute', top:296, left:72, right:72, bottom:48, display:'flex', gap:34}}>
        ...
        <div style={{
          ...
          <div className="mono" style={{fontSize:15.5, letterSpacing:'0.26em', color:'var(--slate)', textTransform:'uppercase', marginTop:20}}>
          ...
          <div className="mono" style={{fontSize:14, letterSpacing:'0.24em', color:'var(--slate)', textTransform:'uppercase', marginTop:8, lineHeight:1.65}}>
        ...
        <div style={{
          ...
          <div style={{display:'flex', alignItems:'baseline', justifyContent:'space-between', paddingBottom:16,
            ...
            <div className="mono" style={{fontSize:15, letterSpacing:'0.34em', color:'var(--gold-deep)', textTransform:'uppercase'}}>
              In this set
            </div>
            <div className="mono" style={{fontSize:14.5, letterSpacing:'0.18em', color:'var(--slate)', fontVariantNumeric:'tabular-nums'}}>
              {pad2(total)} TOTAL
            </div>
          </div>
