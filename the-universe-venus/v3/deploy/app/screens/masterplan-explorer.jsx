...
const PINS = {
  ...
  'main-mp': [
    ...
    { x:57, y:53, kind:'landscape', label:'Central Landscape Garden', sub:'4-acre podium green',
      detail:['The gravitational core — a 4-acre landscaped garden every tower opens onto','Crystal garden, petal garden, mound & seating gardens','Accent trees, step seating & the Grand Stairway'] },
    { x:59, y:35, kind:'social', label:'The Clubhouse · G+1', sub:'Club · Wellness · pool',
      detail:['Single clubhouse anchoring the central area','The Wellness Club (strength, yoga, crossfit, cardio) & podium swimming pool','Banquet, Café Universe, The Lounge, learning room, indoor games, guest rooms'] },
    { x:53, y:42, kind:'wellness', label:'Swimming Pool', sub:'Central pool deck',
      detail:['Swimming pool on the central podium','Pool deck with the Grand Stairway','Changing rooms at the clubhouse'] },
    { x:74, y:21, kind:'sport', label:'Sports Court · Pickleball', sub:'Outdoor courts',
      detail:['Outdoor pickleball court on the 2nd floor','Box cricket, outdoor fitness & jogging track','Children’s playground'] },
...
const MARKERS = {
  ...
  'retail-first': [
    ...
    { num:5, color:'purple', box:{x:47.0,y:70.0,w:25.0,h:9.0}, title:'Clubhouse & Amenities',
      sub:'Indoor amenities', detail:['Clubhouse with The Wellness Club, banquet & indoor games','Café Universe, learning room & lounges','Direct access from the amenity podium'] },
    { num:6, color:'red', box:{x:68.0,y:41.0,w:10.0,h:20.0}, title:'Jogging Track & Sports',
      sub:'Active zone', detail:['Jogging & walking track around the green','Outdoor fitness & sports pockets','Wraps the lawn for an active edge'] },
  ],
  'circ-ab': [
