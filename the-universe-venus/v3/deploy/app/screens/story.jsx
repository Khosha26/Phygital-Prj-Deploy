  ...
  return (
    <div style={{display:'flex', alignItems:'center', gap:28, padding:'0 38px',
      ...
      <div style={{display:'flex', flexDirection:'column', gap:11, minWidth:0}}>
        <div className="mono" style={{fontSize:17, letterSpacing:'0.26em', color:'var(--gold-deep)', textTransform:'uppercase'}}>{label}</div>
  ...
  return (
    <>
      ...
      <div style={{ position:'absolute', left:28, right:28, bottom:24 }}>
        <div className="mono" style={{ fontSize:17, letterSpacing:'0.3em', color:'var(--gold-soft)', textTransform:'uppercase' }}>{kicker}</div>
...
function Story() {
  ...
  const dens = Math.max(clamp((H - 1600) / 320), (typeof window!=="undefined" && window.UNIVERSE_CANVAS && window.UNIVERSE_CANVAS.dens) || 0); // 0 on 16:10 tablet → 1 on iPad Pro 4:3
  ...
  const STATS = [
    { key:'homes',  value:S.homes,    suffix:'',   label:'Residences',     sub:'4 BHK + penthouses' },
    ...
    { key:'sqft',   value:28,         suffix:' L', label:'Sq.ft built-up', sub:'≈ 28,55,241 sq.ft' },
  ];
  const TEAM = [
        ...
        <div style={{height:'100%', display:'flex', flexDirection:'column'}}>
          ...
          <div style={{flex:1, minHeight:0, marginTop:30, marginBottom:30, position:'relative', borderRadius:22, overflow:'hidden',
            ...
            <div style={{position:'absolute', left:36, bottom:32, right:36, display:'flex', alignItems:'flex-end', justifyContent:'space-between', gap:24}}>
              <div>
                <div className="mono" style={{fontSize:17, letterSpacing:'0.32em', color:'var(--gold-soft)', textTransform:'uppercase'}}>Artist's impression</div>
              ...
              <div className="mono" style={{flexShrink:0, fontSize:17, letterSpacing:'0.24em', color:'rgba(253,248,236,0.92)', padding:'11px 20px', borderRadius:999, border:'1px solid rgba(253,248,236,0.32)', background:'rgba(10,8,4,0.28)', backdropFilter:'blur(6px)', WebkitBackdropFilter:'blur(6px)'}}>NEHRU NAGAR · AHMEDABAD</div>
            </div>
          </div>
          ...
          <div style={{flexShrink:0, display:'grid', gridTemplateColumns:'repeat(4,1fr)', border:'1px solid var(--line)', borderRadius:20, overflow:'hidden', background:'linear-gradient(180deg,var(--ivory-2),var(--ivory-3))'}}>
            {STATS.map((d,i)=>(
              <div key={d.key} style={{padding:'26px 30px', borderLeft:i===0?'none':'1px solid var(--line)'}}>
                ...
                <div className="mono" style={{fontSize:17, letterSpacing:'0.28em', color:'var(--gold-deep)', marginTop:12, textTransform:'uppercase'}}>{d.label}</div>
                <div style={{fontSize:20, color:'var(--slate)', marginTop:7}}>{d.sub}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{height:'100%', display:'flex', flexDirection:'column'}}>
          ...
          <div style={{flex:1, minHeight:0, display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:22, marginBottom:32}}>
            {PROOF.map((p,i)=>(
              <div key={p.u} style={{display:'flex', flexDirection:'column', justifyContent:'space-between', padding:'40px 42px', borderRadius:20,
                ...
                <div>
                  <div className="mono" style={{fontSize:17, letterSpacing:'0.32em', color:'var(--slate)', textTransform:'uppercase'}}>{p.cap}</div>
                ...
                <div>
                  ...
                  <div className="mono" style={{fontSize:17, letterSpacing:'0.24em', color:'var(--gold-deep)', textTransform:'uppercase', marginTop:18}}>{p.u}</div>
                  <div style={{fontSize:20, color:'var(--slate)', marginTop:9, lineHeight:1.35}}>{p.d}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{flexShrink:0}}>
            <div style={{display:'flex', alignItems:'center', gap:18, marginBottom:18}}>
              <div className="eyebrow" style={{fontSize:17, letterSpacing:'0.34em', color:'var(--venus-red)'}}>STRATUM · PHASE-1 TENANTS, ALREADY OPERATIONAL</div>
            ...
            {TEAM.map((m,i)=>(
              <div key={m.role} style={{flex:1, minHeight:0, display:'flex', alignItems:'center', gap:40, padding:'0 46px 0 38px', borderRadius:20,
                ...
                <div style={{flex:1, minWidth:0}}>
                  <div className="mono" style={{fontSize:17, letterSpacing:'0.28em', color:'var(--gold-deep)', textTransform:'uppercase'}}>{m.role}</div>
              ...
              <div key={name} style={{display:'flex', alignItems:'center', gap:24, padding:'0 28px', borderRadius:18,
                ...
                <div style={{flex:1, minWidth:0}}>
                  ...
                  <span style={{display:'flex', alignItems:'center', gap:10, marginTop:10}}>
                    ...
                    <span className="mono" style={{fontSize:17, letterSpacing:'0.22em', color:'var(--gold-deep)', textTransform:'uppercase'}}>{m.cat}</span>
                  </span>
                </div>
              </div>
            );})}
    ...
    <div style={{position:'absolute', inset:0, background:'transparent', color:'var(--ink)', overflow:'hidden'}}>
      ...
      <div style={{position:'absolute', top:322, left:72, right:RAIL_W+144, bottom:48,
        ...
        <div style={{flexShrink:0, display:'flex', alignItems:'center', gap:22, marginBottom:30}}>
          <div className="mono" style={{fontSize:17, letterSpacing:'0.34em', color:'var(--gold-deep)', fontWeight:700}}>CHAPTER {ch.num}</div>
        ...
        <div style={{flexShrink:0, marginTop:26, alignSelf:'flex-start', display:'flex', alignItems:'center',
          ...
          <div className="mono" style={{minWidth:118, textAlign:'center', fontSize:17, letterSpacing:'0.16em', color:'var(--slate)'}}>
      ...
      <div style={{position:'absolute', top:322, right:48, width:RAIL_W, bottom:48,
        ...
        <div style={{flexShrink:0, marginBottom:30}}>
          <div className="eyebrow gold" style={{fontSize:17, letterSpacing:'0.4em'}}>EXPLORE THE STORY</div>
          <div style={{display:'flex', alignItems:'center', gap:10, marginTop:13, color:'var(--slate)'}}>
            <span className="mono" style={{fontSize:17, letterSpacing:'0.24em'}}>TAP A CHAPTER</span>
              ...
              return (
                <button key={c.key} onClick={()=>pick(i)}
                  ...
                  <span style={{flex:1, minWidth:0}}>
                    ...
                    <span style={{display:'block', fontSize:20, color:on?'var(--gold-deep)':'var(--slate)', marginTop:8, lineHeight:1.3}}>{c.teaser}</span>
                  </span>
                  {/* trailing affordance */}
                  {on
                    ? <span className="mono" style={{flexShrink:0, fontSize:17, letterSpacing:'0.18em', color:'var(--gold-deep)', fontWeight:700, display:'flex', alignItems:'center', gap:8}}>VIEWING<Icons.arrow width={15} height={15}/></span>
